...
LENGTH=${#OPT1}
if [ $LENGTH > 0 ];then
JAVA_OPTION="$JAVA_OPTION -F$OPT1"
fi
LENGTH=${#OPT2}
if [ $LENGTH > 0 ];then
JAVA_OPTION="$JAVA_OPTION -F$OPT2"
fi
LENGTH=${#OPT3}
if [ $LENGTH > 0 ];then
JAVA_OPTION="$JAVA_OPTION -F$OPT3"
fi
LENGTH=${#OPT4}
if [ $LENGTH > 0 ];then
JAVA_OPTION="$JAVA_OPTION -F$OPT4"
fi
LENGTH=${#OPT5}
if [ $LENGTH > 0 ];then
JAVA_OPTION="$JAVA_OPTION -F$OPT5"
fi
